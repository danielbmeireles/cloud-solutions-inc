...
echo ""
echo "    # Infrastructure's tfbackend.hcl"
echo "    bucket         = \"$BUCKET_NAME\""
echo "    key            = \"$ENVIRONMENT/infra/terraform.tfstate\""
echo "    region         = \"$REGION\""
echo "    use_lockfile   = true"
echo "    encrypt        = true"
echo ""
echo "    # Kubernetes's tfbackend.hcl"
echo "    bucket         = \"$BUCKET_NAME\""
echo "    key            = \"$ENVIRONMENT/kubernetes/terraform.tfstate\""
echo "    region         = \"$REGION\""
echo "    use_lockfile   = true"
echo "    encrypt        = true"
echo ""
